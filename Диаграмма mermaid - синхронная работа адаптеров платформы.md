...
flowchart TD
    ...
    P15 -- Режим работы синхронный --> P14["Запуск адаптеров в синхронном режиме"]
    ...
    P3 -- Сигнал завершения --> P5
    P5 -- Генерация файлов, требуемых модулем генерации Service Worker --> D2
    P5 -- Сигнал завершения --> P7["Завершение обработки конкретной конфигурации"]
